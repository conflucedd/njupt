...
level = IntVar()
level.set(1)
r1 = Radiobutton(root, text = "easy", variable = level, value = 1, font= ("Arial", 20))
r2 = Radiobutton(root, text = "medium", variable = level, value = 2, font= ("Arial", 20))
r3 = Radiobutton(root, text = "hard", variable = level, value = 3, font= ("Arial", 20))
r4 = Radiobutton(root, text = "custom", variable = level, value = 4, font= ("Arial", 20))
